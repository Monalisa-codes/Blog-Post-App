...
const EditProfile = ({ editModal, setEditModal, getUserData }) => {
  ...
  const saveForm = async () => {
    ...
    // If user uploaded a new file (blob or File object)
    if (form.userImg instanceof File) {
      const data = new FormData();
      data.append("file", form.userImg);
      data.append("upload_preset", "unsigned_preset"); // Replace this!
      data.append("cloud_name", "dwqw9lrs7");       // Replace this!
